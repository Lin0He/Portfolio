        ...
        <body>
            <nav>
                <ul className="sidebar">
                    <li className="hideIcon" onClick={hideSidebar}><a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="36" viewBox="0 -960 960 960" width="36"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></li>
                ...
                <div className="container">
                    <div className="name">Lin He's <br/> Portfolio </div>
                </div>
            </nav >
        </body>
    );
